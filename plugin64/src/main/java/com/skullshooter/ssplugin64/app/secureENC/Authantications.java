...
import static com.skullshooter.ssplugin64.app.activities.OAuthVreifications.aboutLogin;
import static com.skullshooter.ssplugin64.app.activities.OAuthVreifications.layoutInfo;
import static com.skullshooter.ssplugin64.app.activities.OAuthVreifications.logFrag;
import static com.skullshooter.ssplugin64.app.activities.OAuthVreifications.login_button;
...
import com.skullshooter.ssplugin64.app.activities.OAuthVreifications;
...
public class Authantications extends AsyncTask<String, Void, String> {
    ...
    private static String URLSERVER = "login.php here";
    Timer _t;
    int _count;
