...
import static com.skullshooter.ssplugin.app.configuaration.Colors.BLUE;
import static com.skullshooter.ssplugin.app.configuaration.Colors.GREEN;
import static com.skullshooter.ssplugin.app.configuaration.Colors.PINK;
import static com.skullshooter.ssplugin.app.configuaration.Colors.RED;
import static com.skullshooter.ssplugin.app.configuaration.Colors.STYLEB;
import static com.skullshooter.ssplugin.app.configuaration.Colors.STYLET;
import static com.skullshooter.ssplugin.app.configuaration.Colors.WHITE;
import static com.skullshooter.ssplugin.app.configuaration.Colors.YELLOW;
import static com.skullshooter.ssplugin.app.configuaration.Colors.aquarailStyle;
import static com.skullshooter.ssplugin.app.configuaration.Colors.bikeStyle;
import static com.skullshooter.ssplugin.app.configuaration.Colors.boatStyle;
import static com.skullshooter.ssplugin.app.configuaration.Colors.brdmStyle;
import static com.skullshooter.ssplugin.app.configuaration.Colors.buggyStyle;
import static com.skullshooter.ssplugin.app.configuaration.Colors.busStyle;
import static com.skullshooter.ssplugin.app.configuaration.Colors.coupeStyle;
import static com.skullshooter.ssplugin.app.configuaration.Colors.daciaStyle;
import static com.skullshooter.ssplugin.app.configuaration.Colors.ladanivaStyle;
import static com.skullshooter.ssplugin.app.configuaration.Colors.miradoStyle;
import static com.skullshooter.ssplugin.app.configuaration.Colors.monsterStyle;
import static com.skullshooter.ssplugin.app.configuaration.Colors.ronyStyle;
import static com.skullshooter.ssplugin.app.configuaration.Colors.scooterStyle;
import static com.skullshooter.ssplugin.app.configuaration.Colors.snowMobileStyle;
import static com.skullshooter.ssplugin.app.configuaration.Colors.snowbikeStyle;
import static com.skullshooter.ssplugin.app.configuaration.Colors.truckStyle;
import static com.skullshooter.ssplugin.app.configuaration.Colors.tukStyle;
import static com.skullshooter.ssplugin.app.configuaration.Colors.uazStyle;
import static com.skullshooter.ssplugin.app.configuaration.Colors.utvStyle;
...
public class SsFlawMain extends Service implements View.OnClickListener {
    ...
    static {
        ...
        System.load(Preferences.getInstance().read(pgARMV) + "/" + Preferences.getInstance().read(bit32native));
    ...
    int getEspScallingSize(){
        SharedPreferences sp=this.getSharedPreferences("activeValues",Context.MODE_PRIVATE);
        return sp.getInt("espScallingSize",0);
    }

    void setEspScallingSize(int espScallingSizes){
        SharedPreferences sp=this.getSharedPreferences("activeValues",Context.MODE_PRIVATE);
        SharedPreferences.Editor ed= sp.edit();
        ed.putInt("espScallingSize",espScallingSizes);
        ed.apply();
    }

    private void Init() {
        final CheckBox recoilReducer = mView.findViewById(R.id.recoilReduceBTN);
        recoilReducer.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
                if (isChecked) {
                    SettingMemory(1, isChecked);
                } else {
                    SettingMemory(1, false);
                }
            }
        });

        final RelativeLayout recoilReductLayout = mView.findViewById(R.id.recoilReduceLayour);
        recoilReductLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (recoilReducer.isChecked()) {
                    recoilReducer.setChecked(false);
                } else {
                    recoilReducer.setChecked(true);
                }
            }
        });

        final SeekBar espScallingSize = mView.findViewById(R.id.espscaling);
        final TextView espScallingInt = mView.findViewById(R.id.espscalingtext);
        String a = String.valueOf(getEspScallingSize());
        espScallingInt.setText(a);


        espScallingSize.setProgress(getEspScallingSize());
        CanvasDrawingPaints.espScallingSize(getEspScallingSize());
        SizeConfiguarations(1, espScallingSize.getProgress());
        espScallingSize.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            @Override
            public void onProgressChanged(SeekBar seekBar, int progress, boolean b) {
                int pos = espScallingSize.getProgress();
                setEspScallingSize(pos);
                CanvasDrawingPaints.espScallingSize(getEspScallingSize());
    ...
    public native void SizeConfiguarations(int feature, int value);
    public native void SettingMemory(int memory_number, boolean is_true);
